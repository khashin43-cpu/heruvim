		...
		<div class=" flex max-w-full w-full mx-auto bg-transparent">
			<div class="flex items-center w-full max-w-full">
				...
				>
					...
					{:else}
						<div class="pointer-events-none flex max-w-full min-w-0 items-center gap-2">
							<img src="/heruvim-mark.svg" alt="" class="size-6 rounded-lg" />
							<div
									class="min-w-0 truncate py-1 text-left text-[15px] font-medium text-[#284b43] dark:text-[#dce9e5]"
							>
								ХЕРУВИМ <span
									class="ml-2 hidden text-xs font-normal tracking-normal text-stone-400 @md:inline"
									>цифровой советник</span
								>
							</div>
						</div>
					{/if}
