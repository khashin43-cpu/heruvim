...
async def upload_file_handler(
    ...
    try:
        ...
        if _heruvim_ragflow_only_uploads() and 'knowledge_id' not in file_metadata:
            process = False
        ...
        if (
            (content_type and content_type.startswith(('image/', 'video/')))
            or file_extension in _HERUVIM_TEXT_EXTENSIONS
        ) and _is_text_file(file_path):
            content_type = 'text/plain'
                ...
                **{
                    ...
                    'data': {
                        ...
                        **(
                            {
                                'status': 'completed',
                                'heruvim_ragflow_only': True,
                                'heruvim_original_process_requested': original_process,
                            }
                            if _heruvim_ragflow_only_uploads() and 'knowledge_id' not in file_metadata
                            else {}
                        ),
