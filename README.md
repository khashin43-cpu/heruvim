...
Это продуктовая модификация Open WebUI для работы с LLM, документами, RAGFlow,
DOCX/PDF MCP и русским OCR. Полная инструкция по установке с нуля, dev-запуску,
Docker и диагностике: **[INSTALL_RU.md](./INSTALL_RU.md)**.

Описание продукта: **[HERUVIM.md](./HERUVIM.md)**. Документный pipeline:
**[HERUVIM_DOCUMENT_PIPELINE.md](./HERUVIM_DOCUMENT_PIPELINE.md)**.

Ниже сохранено upstream-описание Open WebUI.
